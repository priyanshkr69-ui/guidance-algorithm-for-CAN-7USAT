...
print()
print("============================================================")
print("V8.2 WIND SENSITIVITY RESULTS")
print("============================================================")
...
plt.title(
    "V8.2 Landing Error vs Wind Speed"
)
...
plt.title(
    "V8.2 Average Steering vs Wind Speed"
)
